...
function load_data()
{
	 ...
	 $("#content_iframe").attr('src', "http://test3.uscommunities.org/?tx_bnadaptiveprofile=Phone");
	 $.ajax({
	    type: 'GET',
	    ...
	    $('.arrow').on('click', function() { $(this).parent().find(".smallMenu").toggle();});
		$('.link').on('click', function() 
		{
			if($(this).html()=="Contracts" || $(this).html()=="Suppliers" )
